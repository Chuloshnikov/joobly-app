import {
	CountryType,
	PermissionsDataType,
	PlanContainerDataType,
} from "@/lib/types/componentTypes";
import bronze from "@/public/images/logos/bronzePlan.svg";
import gold from "@/public/images/logos/goldPlan.svg";
import silver from "@/public/images/logos/silverPlan.svg";
...
export const JOB_DESCRIPTION =
	...
	"You'll help build the foundation for Stir engineering standards, tooling, and processes.\n" +
	"\n" +
	'"Please be aware of the Fraud Company. The company will never be collecting any payment in the process of interview. Please immediately report to us if there\'s any companies that collecting payment to the Jofind."';

export const REQUIREMENTS = [
	"Proficient knowledge of NodeJS environment is a plus",
	"Comfortable operating in a Linux environment",
	"Experience with version control systems like Git",
	"Experience in creating layouts with mock-up design applications like Figma",
